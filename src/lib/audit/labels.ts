...
const ACTION_LABELS: Record<string, CatalogEntry> = {
  ...
  EQUIPMENT_MODEL_CREATE: {
    ko: " 모델을 등록했습니다",
    en: "registered the model",
    vi: "đã đăng ký mẫu",
    entityHint: "EquipmentModel",
  },
  EQUIPMENT_MODEL_DEACTIVATE: {
    ko: " 모델을 비활성화했습니다",
    en: "deactivated the model",
    vi: "đã ngừng mẫu",
    entityHint: "EquipmentModel",
  },
  EQUIPMENT_MODEL_REACTIVATE: {
    ko: " 모델을 재활성화했습니다",
    en: "reactivated the model",
    vi: "đã kích hoạt lại mẫu",
    entityHint: "EquipmentModel",
  },
  // ── Previously unregistered codes (2026-09-24) ─────────────────
  // Every code below was emitted by a route but missing from this catalog,
  // so the audit screen rendered it with the amber "(미등록)" marker and a
  // machine-derived verb — "(미등록) 시스템 … Contract completed auto".
  CONTRACT_COMPLETED_AUTO: {
    ko: " 계약이 만기로 자동 완료되었습니다",
    en: "was auto-completed at term",
    vi: "đã tự động hoàn tất khi hết hạn",
    entityHint: "Contract",
  },
  CONTRACT_CONVERT: {
    ko: " 계약을 전환했습니다",
    en: "converted the contract",
    vi: "đã chuyển đổi hợp đồng",
    entityHint: "Contract",
  },
  CONTRACT_NOTIFY_RENEWAL: {
    ko: " 계약 갱신 안내를 발송했습니다",
    en: "sent the renewal notice",
    vi: "đã gửi thông báo gia hạn",
    entityHint: "Contract",
  },
  CONTRACT_PDF_UPLOADED: {
    ko: " 계약서 PDF를 업로드했습니다",
    en: "uploaded the contract PDF",
    vi: "đã tải lên PDF hợp đồng",
    entityHint: "Contract",
  },
  CONTRACT_RETRIEVAL_VISIT_AUTO: {
    ko: " 계약의 회수 방문을 자동 생성했습니다",
    en: "auto-created the retrieval visit",
    vi: "đã tự động tạo lượt thu hồi",
    entityHint: "Contract",
  },
  CONTRACT_TERMINATE: {
    ko: " 계약을 해지했습니다",
    en: "terminated the contract",
    vi: "đã chấm dứt hợp đồng",
    entityHint: "Contract",
  },
  CUSTOMER_CONTACT_CREATE: {
    ko: " 연락처를 추가했습니다",
    en: "added the contact",
    vi: "đã thêm liên hệ",
    entityHint: "CustomerContact",
  },
  CUSTOMER_SALES_REP_CHANGED: {
    ko: "의 담당 판매원을 변경했습니다",
    en: "changed the sales rep",
    vi: "đã đổi nhân viên kinh doanh",
    entityHint: "Customer",
  },
  SITE_CREATE: {
    ko: " 사업장을 등록했습니다",
    en: "registered the site",
    vi: "đã đăng ký cơ sở",
    entityHint: "Site",
  },
  EQUIPMENT_INSTALL: {
    ko: " 장비를 설치했습니다",
    en: "installed the equipment",
    vi: "đã lắp đặt thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_BULK_CREATE: {
    ko: " 장비를 일괄 등록했습니다",
    en: "bulk-registered equipment",
    vi: "đã đăng ký hàng loạt thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_BULK_INSTALL: {
    ko: " 장비를 일괄 설치했습니다",
    en: "bulk-installed equipment",
    vi: "đã lắp đặt hàng loạt thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_RETRIEVAL_LOGGED: {
    ko: " 장비 회수를 기록했습니다",
    en: "logged the equipment retrieval",
    vi: "đã ghi nhận thu hồi thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_CONSUMABLE_ADD: {
    ko: " 장비에 소모품 구성을 추가했습니다",
    en: "added a consumable to the equipment",
    vi: "đã thêm lõi lọc cho thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_CONSUMABLE_UPDATE: {
    ko: " 장비의 소모품 구성을 수정했습니다",
    en: "updated the equipment's consumable",
    vi: "đã cập nhật lõi lọc của thiết bị",
    entityHint: "Equipment",
  },
  EQUIPMENT_CONSUMABLE_REMOVE: {
    ko: " 장비의 소모품 구성을 삭제했습니다",
    en: "removed the equipment's consumable",
    vi: "đã xóa lõi lọc của thiết bị",
    entityHint: "Equipment",
  },
  ORDER_CREATE: {
    ko: " 주문을 등록했습니다",
    en: "created the order",
    vi: "đã tạo đơn hàng",
    entityHint: "Order",
  },
  PAYMENT_UPDATED: {
    ko: " 수금 내역을 수정했습니다",
    en: "updated the payment",
    vi: "đã cập nhật khoản thu",
    entityHint: "Payment",
  },
  STOCK_MOVE: {
    ko: " 재고를 조정했습니다",
    en: "recorded a stock move",
    vi: "đã điều chỉnh tồn kho",
    entityHint: "StockMove",
  },
  VISIT_CHARGE_OVERRIDE: {
    ko: " 방문의 유/무상 구분을 변경했습니다",
    en: "overrode the visit's charge decision",
  ...
  CATALOG_IMPORT: {
    ...
    vi: "đã tải lên tệp CSV danh mục",
    entityHint: "CatalogImport",
  },
  ...
  CHARGE_POLICY_UPSERT: {
    ko: " 과금 정책을 저장했습니다",
    en: "saved the charge policy",
    vi: "đã lưu chính sách tính phí",
