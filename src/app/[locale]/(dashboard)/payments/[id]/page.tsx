            ...
            {tab === "overview" && (
              <div className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
                <Row label="Customer" value={
                  <Link href={`/customers/${data.customer.id}`} className="text-[var(--brand-blue-700)] hover:underline">
                    {data.customer.name} ({data.customer.code})
                  </Link>
                } />
                {data.contract && (
                  <Row label="Contract" value={
                    <Link href={`/contracts/${data.contract.id}`} className="text-[var(--brand-blue-700)] hover:underline">
                ...
                {data.visit && (
                  <Row label="Visit" value={
                    <Link href={`/visits/${data.visit.id}`} className="text-[var(--brand-blue-700)] hover:underline">
