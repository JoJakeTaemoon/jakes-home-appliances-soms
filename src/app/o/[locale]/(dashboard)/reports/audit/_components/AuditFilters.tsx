...
const ACTIONS_BY_ENTITY: Record<string, string[]> = {
  ...
  Brand: ["BRAND_CREATE", "BRAND_UPDATE", "BRAND_DEACTIVATE"],
  ProductCategory: [
    "PRODUCT_CATEGORY_CREATE",
    "PRODUCT_CATEGORY_UPDATE",
    "PRODUCT_CATEGORY_DEACTIVATE",
  ],
  ProductType: ["PRODUCT_TYPE_CREATE", "PRODUCT_TYPE_UPDATE", "PRODUCT_TYPE_DEACTIVATE"],
  Consumable: ["CONSUMABLE_CREATE", "CONSUMABLE_UPDATE", "CONSUMABLE_DEACTIVATE"],
  Accessory: ["ACCESSORY_CREATE", "ACCESSORY_UPDATE", "ACCESSORY_DEACTIVATE"],
  SalesRep: ["SALES_REP_CREATE", "SALES_REP_UPDATE", "SALES_REP_DEACTIVATE"],
  ChargePolicy: ["CHARGE_POLICY_UPSERT", "CHARGE_POLICY_UPDATE", "CHARGE_POLICY_DELETE"],
  CatalogImport: ["CATALOG_IMPORT"],
  Order: ["ORDER_CREATE"],
