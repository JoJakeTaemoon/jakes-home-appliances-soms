...
Seoul Aqua SOMS 사용자는 3개 그룹으로 분리되며 각자 **별도 인증 realm** 을 사용한다.
...
- [ ] SMS/Email 템플릿 의 `portal.seoulaqua.com.vn` → 새 path URL 전환 (별도 PR; VI SMS 2-seg → 1-seg, 월 ~440K-890K VND 절감 예상)
