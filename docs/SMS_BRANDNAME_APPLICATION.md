...
> **2026-09-12 업데이트** — 브랜드네임은 승인됐고 잔액도 있습니다. 실제 발송으로 확인한 결과 등록된 문안은 정기점검 알림(베트남어·영어) 하나뿐이고 나머지 7종은 모든 언어에서 거부됩니다. 언어별 판정 결과와 추가 등록 요청서는 `docs/SMS_TEMPLATE_REGISTRATION.md`에 있습니다.
