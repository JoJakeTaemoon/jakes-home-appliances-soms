# Seoul Aqua 고객 포털 사용 안내 (Customer Manual)

**대상**: Seoul Aqua의 모든 손님 — 가정집 (B2C) 및 회사 (B2B)
**버전**: 2026-06-02
**언어**: 한국어
**관련 문서**: [현장 기사 매뉴얼](./field.md)

이 안내서는 Seoul Aqua의 정수기·공기청정기·비데를 사용하시는 손님을 위한 것입니다. 핸드폰에서 고객 포털을 통해 본인의 장비, 다음 점검 일정, 결제 내역을 직접 확인하고 서비스를 요청하는 모든 방법을 설명합니다.

---

## 목차

- [1장. 시작하기 — Seoul Aqua 고객 포털이란?](#1장-시작하기--seoul-aqua-고객-포털이란)
...
## 1장. 시작하기 — Seoul Aqua 고객 포털이란?

### 1.1 어떤 서비스인가요?

Seoul Aqua는 베트남에서 정수기·공기청정기·비데를 **팔고, 임대해 드리고, 정기적으로 관리**해 드리는 회사입니다. 손님께 매번 사무실에 전화하시지 않아도 **포털**에서 직접:
...
| **RECEIVED** | 받음 | Seoul Aqua가 송금 받음 (매칭 전) |
...
은행: Vietcombank
계좌: 0123456789
계좌주: CÔNG TY TNHH MTV TM&DV ĐẠI Á
지점: HCMC
```
...
1. 송금 영수증 (은행 앱 캡처) 준비
2. Seoul Aqua 사무실에 **전화 또는 이메일** 문의
3. 매뉴얼 매칭 후 정상 처리됨
...
- 포털에서는 **변경 불가** (법적 영향 큼)
- Seoul Aqua 사무실에 **전화 또는 이메일**로 요청
...
- **누구에게도 알려주지 마세요** — Seoul Aqua 직원도 본인 비밀번호를 묻지 않습니다
- 종이에 그대로 적지 마세요
...
- Seoul Aqua는 **비밀번호를 직접 묻는 SMS/이메일을 보내지 않습니다**
- 사칭 메시지 의심되면 직접 사무실 전화로 확인

### 16.4 휴대폰 분실 시

1. **즉시 Seoul Aqua 사무실**에 연락
...
### 17.3 Seoul Aqua 사무실 연락처

```
회사명: CÔNG TY TNHH MTV TM&DV ĐẠI Á
주소: Số 47 Hoàng Trọng Mậu, P. Tân Hưng, TP. Hồ Chí Minh
전화: (실제 회사 번호)
이메일: cs@seoulaqua.com.vn
```
...
**A**: 
1. 즉시 Seoul Aqua 사무실에 연락 → 모든 세션 강제 종료
2. 새 휴대폰 받은 후 "비밀번호 찾기"로 새 임시 비번 → 로그인 → 비밀번호 변경

### Q4. 영수증·세금계산서를 컴퓨터에서 받고 싶어요

**A**: 컴퓨터 브라우저로 같은 주소(`seoulaqua.com.vn/login`)에서 로그인하시면 PDF 다운로드 가능합니다.
...
오랜 시간 함께해 주셔서 감사합니다 — Seoul Aqua 드림.
