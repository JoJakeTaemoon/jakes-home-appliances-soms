# Hướng dẫn sử dụng Cổng Khách hàng Jake's Home Appliances (Customer Manual)

**Đối tượng**: Toàn bộ khách hàng của Jake's Home Appliances — Hộ gia đình (B2C) và Doanh nghiệp (B2B)
**Phiên bản**: 2026-06-02
**Ngôn ngữ**: Tiếng Việt
**Tài liệu liên quan**: [Hướng dẫn Kỹ thuật viên](./field.md)

Hướng dẫn này dành cho khách hàng sử dụng máy lọc nước·máy lọc không khí·bồn cầu thông minh của Jake's Home Appliances. Mô tả mọi cách kiểm tra thiết bị, lịch bảo trì kế tiếp, lịch sử thanh toán và yêu cầu dịch vụ trực tiếp qua Cổng Khách hàng trên điện thoại.

---

## Mục lục

- [Chương 1. Bắt đầu — Cổng Khách hàng Jake's Home Appliances là gì?](#chương-1-bắt-đầu--cổng-khách-hàng-jakes-home-appliances-là-gì)
...
## Chương 1. Bắt đầu — Cổng Khách hàng Jake's Home Appliances là gì?

### 1.1 Dịch vụ này là gì?

Jake's Home Appliances là công ty tại Việt Nam **bán, cho thuê và bảo trì định kỳ** máy lọc nước·máy lọc không khí·bồn cầu thông minh. Quý khách không cần gọi văn phòng mỗi lần, có thể trực tiếp trên **Cổng**:
...
flowchart TB
  ...
  D --> E[Hàng tháng / Cách tháng<br/>Bảo trì định kỳ + Hóa đơn<br/>Tự động]

  E -.->|Khi cần| F[Gửi yêu cầu dịch vụ<br/>từ cổng]
  F -->|Miễn phí| G[Tự duyệt<br/>Có lịch ngay]
  F -->|Có phí| H[Nhận SMS báo giá]
  H -->|Đồng ý| I[Sau chuyển khoản có lịch]
  G --> E
  I --> E

  E --> J[Năm 3<br/>Thông báo hết hạn thuê<br/>D-60 D-30 D-7]
  J --> K{Lựa chọn}
  K --> L[Chuyển sang bảo trì<br/>Chuyển sở hữu thiết bị]
  K --> M[Kết thúc<br/>Lượt thăm thu hồi thiết bị]
```
...
```
[Jake's Home Appliances] Đăng ký Cổng Khách hàng đã hoàn tất.
Mật khẩu tạm thời: ********
Đăng nhập: jakeshomeappliances.com.vn/login
```
...
![Màn hình đăng nhập](../screenshots/vi/customer/01-login.png)
...
![Màn hình Trang chủ](../screenshots/vi/customer/02-home.png)
...
![Lịch sử thăm](../screenshots/vi/customer/04-visits.png)
...
4. **Gửi yêu cầu** → Được chuyển đến văn phòng Jake's Home Appliances
...
![Yêu cầu dịch vụ](../screenshots/vi/customer/05-requests.png)
...
![Yêu cầu mới](../screenshots/vi/customer/06-requests-new.png)
...
sequenceDiagram
  participant Khách
  participant Cổng
  participant VP as Văn phòng
  participant KTV

  Khách->>Cổng: Gửi yêu cầu (kèm ảnh)
  Cổng-->>Khách: Email "Đã tiếp nhận, đang xem xét"
  VP->>Cổng: Đánh giá + Nhập báo giá
  Cổng-->>Khách: SMS "Báo giá ____, lịch ____" + Email (PDF báo giá)
  Khách->>VP: Chuyển khoản
  VP->>Cổng: Đối soát chuyển khoản + Xác nhận lịch thăm
  Cổng-->>Khách: SMS "Đã xác nhận lịch"
  KTV->>Khách: Đến + Làm việc
  Cổng-->>Khách: Email (PDF phiếu xác nhận công việc)
```
...
| **RECEIVED** | Đã nhận | Jake's Home Appliances đã nhận chuyển khoản (chưa đối soát) |
...
Nội dung hóa đơn:
- Thông tin công ty Jake's Home Appliances
- Thông tin quý khách
...
Chủ tài khoản: CÔNG TY TNHH MTV TM&DV JAKE'S HA
Chi nhánh: HCMC
```
...
2. **Gọi điện hoặc email** văn phòng Jake's Home Appliances
...
Khi Jake's Home Appliances phát hành hóa đơn GTGT:
...
![Quản lý liên hệ](../screenshots/vi/customer/09-contacts.png)
...
- Yêu cầu **gọi điện hoặc email** văn phòng Jake's Home Appliances
...
![Thông tin của tôi](../screenshots/vi/customer/10-settings.png)
...
#### Yêu cầu văn phòng Jake's Home Appliances
...
2. Báo văn phòng Jake's Home Appliances
...
- **Đừng cho ai biết** — Cả nhân viên Jake's Home Appliances cũng không hỏi mật khẩu quý khách
...
- Jake's Home Appliances **không gửi SMS/email trực tiếp hỏi mật khẩu**
- Nghi tin nhắn giả mạo thì xác nhận trực tiếp bằng cách gọi văn phòng

### 16.4 Khi mất điện thoại

1. **Liên lạc văn phòng Jake's Home Appliances ngay**
...
### 17.3 Liên hệ văn phòng Jake's Home Appliances

```
Tên công ty: CÔNG TY TNHH MTV TM&DV JAKE'S HA
Địa chỉ: Số 47 Hoàng Trọng Mậu, P. Tân Hưng, TP. Hồ Chí Minh
Điện thoại: (số công ty thực tế)
Email: cs@jakeshomeappliances.com.vn
```
...
**A**: 
1. Liên lạc văn phòng Jake's Home Appliances ngay → Buộc kết thúc mọi phiên
...
**A**: Đăng nhập cùng địa chỉ (`jakeshomeappliances.com.vn/login`) trên trình duyệt máy tính có thể tải PDF.
...
Cảm ơn quý khách đã đồng hành cùng chúng tôi — Jake's Home Appliances kính chào.
